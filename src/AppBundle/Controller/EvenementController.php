...
class EvenementController extends Controller
{
     ...
     *
     * @Route("/{id}/new", name="evenement_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request,SemainePlage $semainePlage)
    {
        $evenement = new Evenement();
        $heureDebut=$request->get('h');
        $dateDebut=$request->get('date');
        $dateTimeDebut = \DateTime::createFromFormat("Ymd H:i",$dateDebut.' '.$heureDebut);
        $evenement->setDebut($dateTimeDebut);
